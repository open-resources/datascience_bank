...
myst:
  substitutions:
    ...
    params_vars_quote_text: When in Rome, do as the Romans do.
    params_vars_is_f_string: f
    params_vars_first_text: When in Rome, do as the
    params_vars_variable: quote_text
    params_vars_second_text: '{quote_text}'
    params_part1_ans1_value: quote("Romans do.")
    ...
    params_part1_ans3_value: def quote("Romans do.")
    params_part1_ans3_feedback: Try again!
    params_part1_ans4_value: quote(Romans do.)
