...
myst:
  substitutions:
    ...
    params_vars_quote_text: quote_text words.
    params_vars_is_f_string: f
    params_vars_second_text: words.
    params_vars_variable: quote_text
    params_vars_first_text: quote_text
    params_part1_ans1_value: quote("Actions speak louder than")
    ...
    params_part1_ans3_value: def quote("Actions speak louder than")
    params_part1_ans3_feedback: Try again!
    params_part1_ans4_value: quote(Actions speak louder than)
