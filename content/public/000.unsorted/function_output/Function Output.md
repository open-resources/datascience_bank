...
myst:
  substitutions:
    ...
    params_vars_first_text: Laughter is the best
    params_vars_variable: quote_text
    params_vars_second_text: quote_text
    params_part1_ans1_value: quote("medicine.")
    ...
    params_part1_ans3_value: def quote("medicine.")
    params_part1_ans3_feedback: Try again!
    params_part1_ans4_value: quote(medicine.)
